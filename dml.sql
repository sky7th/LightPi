insert into user_info ( user_login_id, user_login_pw ) values ( 'sky7th', '0000' ); -- 나
insert into user_info ( user_login_id, user_login_pw ) values ( 'companyId', '0000' ); -- 회사 관리자
insert into user_info ( user_login_id, user_login_pw ) values ( 'libraryId', '0000' ); -- 도서관 관리자
insert into user_info ( user_login_id, user_login_pw ) values ( 'healthId', '0000' ); -- 헬스장 관리자
